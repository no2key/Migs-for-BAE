...
function fileQueued(file) {
	if ( $('#fsUploadProgress').length ) {
		$('#fsUploadProgress').append('<div id="' + file.id + '" class="u-wrap"><div class="u-inside"><a class="u-cancel"  onclick="set_cancel(\'' + file.id + '\')" href="javascript:void(0)">Cancel</a><div class="u-name">' + file.name + '</div><div class="u-status">等待...</div><div class="u-bar"></div></div></div>');
	}
